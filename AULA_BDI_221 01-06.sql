...
-- QUANTO CADA FUNCINÁRIO TOTAL DE VENDAS
SELECT
	F.NOME,
...
-- 1) MOSTRE OS SALÁRIOS DE TODOS OS FUNCIONÁRIOS DA DO PETSHOP, DO MAIOR PARA O MENOR

SELECT NOME,SALARIO FROM FUNCIONARIO 
ORDER BY SALARIO DESC


-- 2) QUAIS SÃO OS SERVIÇOS QUE O PETSHOP OFERECE ?
...
-- 3) QUAIS OS PRODUTOS QUE EU CONSIGO COMPRAR NA LOJA COM 50.00 REAIS ?

SELECT VALOR, NOME FROM PRODUTO
GROUP BY NOME, VALOR
HAVING VALOR < 50.0
ORDER BY VALOR DESC

-- 4) MOSTRE O HISTÓRICO DE VENDAS DOS PRODUTOS

SELECT * FROM PRODUTO A
INNER JOIN VENDA B 
ON A.ID = B.ID

-- 5) QUAIS OS PRODUTOS FORAM VENDIDOS VIA PICPAY ?
...
WHERE DESCRICAO = 'PICPAY';


-- 6) FAÇA UM RANKING DE VENDAS DOS VENDEDORES
